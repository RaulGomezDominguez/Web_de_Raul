...
<head>
    <title>Sistema de tickets area</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
?>
    ...
    <div class="container h-100" style="padding-top: 1rem;" >  
        <div class="row justify-content-center align-item-center h-100">
                ...
                <div class="card-body">
        <center><h2>Sistema de Tickets</h2><h4>Area</h4></center>
                        </div> 
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center align-item-center h-100">
            ...
            <div class="card border-primary">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label for="exampleInputText" class="form-label">Nombre Area</label>
...
<thead>
    <tr>
        <th scope="col">Núm.</th>
        <th scope="col">Nombres de Areas</th>
        <th scope="col"></th>
        <th scope="col"></th>
    </tr>
</thead>
    ...
    <tr>
        ...
        <td><a href="./functions/delete.php?id=<?php echo $fila['id_area'];?>"><i class="bi bi-trash text-danger"></i></a></td>
    </tr>
        <?php $contador++;}?>
    </div>
</tbody>
