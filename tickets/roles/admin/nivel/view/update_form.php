...
<div class="container h-100 " style="padding-top: 1rem;" >  
        <div class="row justify-content-center align-item-center h-100">
                ...
                <div class="card-body">
        <center><h2>Actualización de Tickets</h2><h4>Niveles</h4></center>
                        </div> 
                    </div>
                </div>
            </div>
            ...
            <form action="../functions/update.php" method="post">
                <div class="mb-3">
                    <label for="exampleInputText" class="form-label">Nombre Nivel</label>
                        <input name="nombre" value="<?php echo $fila['nombre_nivel'];?>" type="text" class="form-control border-primary ">
                        </div>
